...
const properties = [
  {
    ...
    type: "Apartment",
    description:
      "A beautiful modern apartment in the heart of the city. Perfect for young professionals or small families.",
  ...
  },
  {
    ...
    type: "Villa",
    description:
      "Luxurious villa with stunning views and top-of-the-line amenities. Ideal for those seeking the ultimate in comfort and style.",
